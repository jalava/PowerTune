...
*/
DecoderApexi::DecoderApexi(QObject *parent)
    : QObject(parent)
    , m_dashboard(Q_NULLPTR)
{
}

DecoderApexi::DecoderApexi(DashBoard *dashboard, QObject *parent)
    : QObject(parent)
    , m_dashboard(dashboard)
{
}

void DecoderApexi::setUnits(const int &unitSelect)
{
    units = unitSelect;
    if (units == 0 )
...
void DecoderApexi::decodeAdv(QByteArray serialdata)
{
...
void DecoderApexi::decodeSensor(QByteArray serialdata)
{
...
void DecoderApexi::decodeAux(QByteArray serialdata)
{
...
void DecoderApexi::decodeAux2(QByteArray serialdata)
{
...
void DecoderApexi::decodeMap(QByteArray serialdata)
{
...
void DecoderApexi::decodeBasic(QByteArray serialdata)
{
...
void DecoderApexi::decodeRevIdle(QByteArray serialdata)
{
...
void DecoderApexi::decodeTurboTrans(QByteArray serialdata)
{
...
void DecoderApexi::decodeLeadIgn(QByteArray serialdata, quint8 column)
{
...
void DecoderApexi::decodeTrailIgn(QByteArray serialdata, quint8 column)
{
...
void DecoderApexi::decodeInjcorr(QByteArray serialdata, quint8 column)
{
...
void DecoderApexi::decodeFuelBase(QByteArray serialdata, quint8 package)
{
    quint8 index = 0;
    ////qDebug() << "add package!";
...
void DecoderApexi::decodeBoostCont(QByteArray serialdata)
{
...
void DecoderApexi::decodeInjOverlap(QByteArray serialdata)
{
...
void DecoderApexi::decodeVersion(QByteArray serialdata)
{
    //    ui->lineVersion->setText (QString(serialdata).mid(2,5));
}
void DecoderApexi::decodeInit(QByteArray serialdata)
{
...
void DecoderApexi::decodeSensorStrings(QByteArray serialdata)
{
...
void DecoderApexi::decodeInjPriLagvsBattV(QByteArray serialdata)
{
...
void DecoderApexi::decodeInjScLagvsBattV(QByteArray serialdata)
{
...
void DecoderApexi::decodeFuelInjectors(QByteArray serialdata)
{
...
void DecoderApexi::loggerAdaptronic(QString Logfilename)
{
Logfile = Logfilename+".csv";
loggerStartTime.restart();
}

void DecoderApexi::loggerApexi(QString Logfilename)
{
...
void DecoderApexi::loggerActivationstatus(int loggingstatus)
{
Loggerstat = loggingstatus;
//qDebug() <<"Decoder loggingstatus"<< loggingstatus;
}
void DecoderApexi::calculatorAux(int aux1min,int aux2max,int aux3min,int aux4max,QString Auxunit1,QString Auxunit2)
{
    auxval1 = aux1min;
    auxval2 = aux2max;
    auxval3 = aux3min;
